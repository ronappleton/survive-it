...
func (m menuModel) viewRunCommandLibrary() string {
	...
	lines := []string{
		...
		green.Render("wood dry [kg] [p#]"),
		green.Render("wood stock"),
		green.Render("resources"),
		green.Render("collect <resource|any> [qty] [p#]"),
		green.Render("fire status"),
		green.Render("fire methods"),
		green.Render("fire prep tinder|kindling|feather [count] [p#]"),
		green.Render("fire ember bow|hand [woodtype] [p#]"),
		green.Render("fire ignite [woodtype] [kg] [p#]"),
